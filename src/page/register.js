...
const Register = () => {
    ...
    async function handleRegister(event) {
        ...
        try{
            ...
            // const resp = await fetch('http://localhost:8000/register', postRequest)
